...
func (m *MockFileRepository) UploadPublicFile(ctx context.Context, bucketName, objectName, contentType string, file io.Reader) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UploadPublicFile", ctx, bucketName, objectName, contentType, file)
	ret0, _ := ret[0].(error)
	return ret0
}

// UploadPublicFile indicates an expected call of UploadPublicFile.
func (mr *MockFileRepositoryMockRecorder) UploadPublicFile(ctx, bucketName, objectName, contentType, file any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UploadPublicFile", reflect.TypeOf((*MockFileRepository)(nil).UploadPublicFile), ctx, bucketName, objectName, contentType, file)
}
